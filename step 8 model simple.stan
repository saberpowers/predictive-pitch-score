data {
  ...
  row_vector[24] bshweights; //context weights
}
...
transformed parameters {
  ...
  lambda[1,1:c]=-(bshweights[2:24] * lambda[2:24,1:c])/bshweights[1]; //Honestly not certain how necessary this is but like having it
  zeta[1,1:c]=1+-(bshweights[2:24] * (zeta[2:24,1:c]-1))/bshweights[1];
